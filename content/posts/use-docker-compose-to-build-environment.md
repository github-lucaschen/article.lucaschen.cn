...
> **Tips:** change the value of `MYSQL_ROOT_PASSWORD` to your own password.
...
```shell
mkdir logs data
touch redis.conf docker-compose.yml
```
...
> **Tips:** change the value of `requirepass` to your own password.
...
> **Tips:**
>
> change the value of `POSTGRES_PASSWORD` to your own password.
>
> change the value of `POSTGRES_USER` to your own username.
...
> **Tips:**
>
> change the value of `RABBITMQ_DEFAULT_PASS` to your own password.
>
> change the value of `RABBITMQ_DEFAULT_USER` to your own username.
...
**Step 4:** Open the management page
...
> **Tips**
> The versions of the three components must be consistent
> elasticsearch
> kibana
> elasticsearch-analysis-ik

**Step 5:** Open the management page
